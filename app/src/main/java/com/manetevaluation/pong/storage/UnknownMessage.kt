...
import com.manetevaluation.pong.NoiseDatabase
...
open class UnknownMessage : BaseRXModel {
    ...
    fun writeToSink(sink: BufferedSink) {
        ...
        sink.writeLong(internalId)
        sink.writeInt(hopNumber)
    ...
    override fun equals(`object`: Any?): Boolean {
        ...
        return version == `object`.version &&
                ...
                publicType == `object`.publicType && internalId == `object`.internalId
    }
    ...
    companion object {
        ...
        fun rawCreateAndSignAsync(idMessage : Long, payload: ByteArray, zeroBits: Byte, publicType: UUID): Single<UnknownMessage> {
            var payload = payload
        ...
        fun fromSource(source: BufferedSource): UnknownMessage {
            ...
            message.internalId = source.readLong()
            message.hopNumber = source.readInt()
